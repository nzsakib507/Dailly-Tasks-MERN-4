...
//     // filter by profession and age
//     if (currentValue.profession.toLocaleLowerCase === "Student" && currentValue.age <= 25) return true;
//     return false;
// });


// const output = people.map(function(currentElement){
//     return {
//         ... currentElement,
//         name: currentElement.name.toUpperCase()
//     }
// });
...
const output = people.filter(function(currentValue){
    ...
    if(currentValue.profession.toLocaleLowerCase() === 'teacher' || currentValue.profession.toLocaleLowerCase() === 'student' || currentValue.profession.toLocaleLowerCase() === 'doctor'){
        return true;
    };
    return false;
